...
// import { updateProfile } from "../../actions/profileAction.js";
...
const LoginSignUp = () => {
  ...
  const LoginSignUp = useSelector((state) => state.user || {});
  const { error, loading, isAuthenticated } = LoginSignUp;
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <Fragment>
        <MetaData title="LoginSignUp Page" />
